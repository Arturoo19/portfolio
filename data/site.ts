      ...
      items: [
        {
          ...
          period: "2026 - Present",
          summary:
            "Hands-on experience managing cloud infrastructure and Linux production environments, focused on operational continuity, security, and incident resolution.",
          points: [
            "Managed and migrated virtual machines in production environments, including configuration, maintenance, and incident resolution.",
            "Administered AWS EC2 infrastructure, including instance configuration, maintenance, and day-to-day management.",
            "Worked daily with Linux from the terminal and used Git for version control, traceability, and change management.",
            "Diagnosed and fixed technical incidents and configuration errors by identifying root causes to reduce operational impact.",
            "Contributed to cybersecurity tasks: log and incident monitoring, access and IAM management, patches, and security updates.",
            "Used Claude Code from the terminal to speed up development, analysis, and technical support tasks.",
          ],
      ...
      items: [
        {
          ...
          summary:
            "Experiencia practica administrando infraestructura cloud y entornos Linux en produccion, con foco en continuidad operativa, seguridad y resolucion de incidencias.",
          points: [
            "Gestion y migracion de maquinas virtuales en entornos de produccion, incluyendo configuracion, mantenimiento y resolucion de incidencias.",
            "Administracion de infraestructura en AWS EC2: configuracion, mantenimiento y gestion diaria de instancias.",
            "Trabajo diario con Linux desde terminal y Git para control de versiones, trazabilidad y gestion de cambios.",
            "Diagnostico y correccion de incidencias tecnicas y errores de configuracion, identificando la causa raiz para reducir el impacto operativo.",
            ...
            "Uso de Claude Code desde terminal para agilizar tareas de desarrollo, analisis y soporte tecnico.",
          ],
          tags: ["AWS EC2", "Linux", "Git", "IAM", "Logs", "Claude Code"],
        },
        {
      ...
      items: [
        {
          ...
          period: "2026 - дотепер",
          summary:
            "Практичний досвід адміністрування cloud-інфраструктури та Linux-середовищ у продакшні з фокусом на стабільність, безпеку й вирішення інцидентів.",
          points: [
            "Керування та міграція віртуальних машин у продакшн-середовищах, включно з конфігурацією, підтримкою та вирішенням інцидентів.",
            "Адміністрування інфраструктури AWS EC2: налаштування, підтримка й щоденне керування інстансами.",
            "Щоденна робота з Linux через термінал і Git для контролю версій, відстеження змін та керування змінами.",
            "Діагностика та виправлення технічних інцидентів і помилок конфігурації через пошук першопричини для зменшення операційного впливу.",
            "Участь у задачах кібербезпеки: моніторинг логів та інцидентів, керування доступами й IAM, патчі та оновлення безпеки.",
            "Використання Claude Code у терміналі для прискорення задач розробки, аналізу та технічної підтримки.",
          ],
